...
public class DevicesController {
	...
	public String explore() throws IOException {
		String data = "[{\"data\":\"Devices\",\"attr\":\"0\",\"children\":[{\"attr\":{\"id\":\"1\"},\"data\":\"DVB-S/DVB-S2/MPEG-2\"},{\"attr\":{\"id\":\"2\"},\"data\":\"CAS modules\"},{\"attr\":{\"id\":\"3\"},\"data\":\"CVBS/RGB/YPbPr, \"},{\"attr\":{\"id\":\"4\"},\"data\":\"USB2.0 port, \"},{\"attr\":{\"id\":\"5\"},\"data\":\"PVR, \"},{\"attr\":{\"id\":\"6\"},\"data\":\"Multimedia player\"},{\"attr\":{\"id\":\"7\"},\"data\":\"SCPC and MCPC\"},{\"attr\":{\"id\":\"8\"},\"data\":\"DiSEqC 1.0/1.1/1.2/1.3 (USALS)\"},{\"attr\":{\"id\":\"9\"},\"data\":\"LNB, NIT search\"},{\"attr\":{\"id\":\"10\"},\"data\":\"Softwareupgrade over OTA\"},{\"attr\":{\"id\":\"11\"},\"data\":\"DiSEqC1.0/DiSEqC1.2\"},{\"attr\":{\"id\":\"12\"},\"data\":\"EPG,\"},{\"attr\":{\"id\":\"13\"},\"data\":\"VBI teletext\"},{\"attr\":{\"id\":\"14\"},\"data\":\"F950 to 2,150MHz\"},{\"attr\":{\"id\":\"15\"},\"data\":\"auto/manual program search\"},{\"attr\":{\"id\":\"16\"},\"data\":\"Multiple Languages\"},{\"attr\":{\"id\":\"17\"},\"data\":\"USB2.0 for PVR\"},{\"attr\":{\"id\":\"18\"},\"data\":\"LDPC/BCH \"},{\"attr\":{\"id\":\"19\"},\"data\":\"VHF & HUF bands\"}]}]";
		return data;
	}
	...
	@ResponseBody
	public boolean uploadFile(MultipartHttpServletRequest request, HttpServletResponse response) throws IOException {
		 Iterator<String> itr =  request.getFileNames();
		 MultipartFile mpf = request.getFile(itr.next());
		 String fileName = "Uploaded_"+RTPSplitterConstant.FILE_NAME;
		 URL url = getClass().getResource(fileName);
		 File uploadFile = new File(url.getPath());
		 FileOutputStream fos = new FileOutputStream(uploadFile);
		 fos.write(mpf.getBytes());
		 fos.close();
		 rtpSplitterServices.updateUploadFileLocation(url.getPath());
		return true;
	}
