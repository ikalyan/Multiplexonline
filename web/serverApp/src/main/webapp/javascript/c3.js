(function (window) {
    ...
    c3_chart_internal_fn.initWithData = function (data) {
        ...
        var bgGradient = $$.svg.append("svg:defs").append("svg:linearGradient").attr("id", "bgGradient").attr("x1", "0%").attr("y1", "0%").attr("x2", "0%").attr("y2", "10%").attr("spreadMethod", "repeat");
        bgGradient.append("svg:stop").attr("offset", "0%").attr("stop-color", "#eee").attr("stop-opacity", 1);
        bgGradient.append("svg:stop").attr("offset", "50%").attr("stop-color", "#eee").attr("stop-opacity", 1);     
        bgGradient.append("svg:stop").attr("offset", "51%").attr("stop-color", "#fff").attr("stop-opacity", 0);
        bgGradient.append("svg:stop").attr("offset", "100%").attr("stop-color", "#fff").attr("stop-opacity", 0);
        $$.clipGrid = $$.svg.append("rect").attr("width", "100%").attr("height", "90.5%").attr("fill", "pink").style("fill", "url(#bgGradient)");
    ...
    c3_chart_internal_fn.updateSvgSize = function () {
        ...
        $$.selectChart.style('max-height', 500 + "px");
    };
